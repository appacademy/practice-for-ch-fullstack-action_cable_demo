...
Start by downloading the demo starter. Follow the typical setup routine: `bundle
install`, `rails db:setup`,  `npm install`, and finally `npm start`.
...
jump ahead by requesting the solution. Visit the Basic Workflow reading for a
high-level, generalized summary of the steps you took above.